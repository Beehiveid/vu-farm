...
<v-container>
    <v-row>
        <template>
            <v-data-table :search="search" :headers="headers" :items="warehouses" class="elevation-1">
                <template v-slot:top>
                                    ...
                                    <v-container>
                                        <v-row>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.name" label="Warehouse Name"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            ...
            confirm('Are you sure you want to delete this warehouse?') && this.warehouses.splice(index, 1)
        },
